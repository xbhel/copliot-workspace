...
9. Create a concrete unit testing skill by calling `creating-unit-testing-skills` skill and output the result along with a brief summary of the inferred assumptions.
